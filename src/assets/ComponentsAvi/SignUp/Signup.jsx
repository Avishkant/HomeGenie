...
function Signup() {
    return (
        ...
        //     <div className="w-2/5 p-6 m-auto bg-white rounded-md shadow-md lg:max-w-xl">
            ...
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div className="max-w-md mx-auto">
                        <div>
                            <h1 className="text-2xl font-semibold  mx-12">SignUp</h1>
                        </div>
                        <div className="underline h-0.5 w-13  bg-green-600"></div>
